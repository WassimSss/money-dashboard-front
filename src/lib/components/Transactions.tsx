...
const Transactions: React.FC = () => {
    const mediaQueriesStyle = {
        ...
        mdStyle:"md:row-start-4 md:row-end-5 md:col-start-1 md:col-end-3 m-4 p-3 flex flex-col",
        smStyle:"xl:row-start-2 xl:row-end-4 xl:col-start-4 xl:col-end-5 m-4 p-3 flex flex-col",
    }
    
    return (
        <div id="Transactions" className={`${mediaQueriesStyle.xlStyle} ${mediaQueriesStyle.lgStyle} ${mediaQueriesStyle.mdStyle} bg-neutral-800 rounded-2xl m-4 text-white p-3 flex flex-col `}>
